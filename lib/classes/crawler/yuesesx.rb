# encoding: utf-8
class Crawler::Yuesesx
  include Crawler

  def crawl_article article

    @page_html.css("iframe,script").remove
    text = change_node_br_to_newline(@page_html.css("div.cont")).strip
  ...
  def crawl_articles novel_id
    ...
    nodes.each do |node|
      ...
      unless article 
        ...
        article.link = "http://www.yuesesx.com" + node[:href]
