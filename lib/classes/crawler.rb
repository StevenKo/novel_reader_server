module Crawler
  ...
  def fetch_other_site url
    ...
    elsif (url.index('shanwen')|| url.index('shushu')|| url.index('sj131') || url.index('59to.com') || url.index('quanben') || url.index('xianjie') || url.index('u8xs') || url.index('dawenxue') || url.index('shu88') || url.index('77wx') || url.index('xuanhutang') || url.index('5ccc.net') || url.index('520xs') || url.index('92txt.net') || url.index('ranwenxiaoshuo') || url.index('qbxiaoshuo') || url.index('xhxsw')|| url.index('lwxs') || url.index('5200xs') || url.index('hfxs') || url.index('5800.cc') || url.index('bjxiaoshuo') || url.index('d586.com') || url.index('bookzx.net') || url.index('qizi.cc') || url.index('ttshuo') || url.index('wenku8.cn') || url.index('wsxs.net') || url.index('yawen8') || url.index('fftxt.net')  || url.index('qbxs8'))
