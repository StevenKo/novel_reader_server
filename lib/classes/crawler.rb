module Crawler
  ...
  def fetch_other_site url
    ...
    if url.index('shushu5')||url.index('kushuku')||url.index('feiku.com')|| url.index('daomubiji') || url.index('luoqiu.com') || url.index('kxwxw') || url.index('txtbbs.com') || url.index('lightnovel.cn') || url.index('tw.xiaoshuokan') || url.index('tw.57book')
