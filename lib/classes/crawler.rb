module Crawler
  ...
  def fetch url
    @fake_browser_urls = ["b.faloo.com","www.ttzw.com","www.8535.org","6ycn.net","www.readnovel.com","www.d586.com","www.fftxt.com","www.bixiage.com"]
    @do_not_encode_urls = ['59to.org','book.sfacg','ranwenba','shushu5','kushuku','feiku.com','daomubiji','luoqiu.com','kxwxw','txtbbs.com','lightnovel.cn','tw.57book','b.faloo.com/p/','9pwx.com','wcxiaoshuo','tw.xiaoshuokan']
    @page_url = url
    get_page(@page_url)   
  end
